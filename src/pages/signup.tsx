  ...
  return (
    <div className='flex justify-center'>
     ...
     <h1 className="font-bold text-[35px]">Sign Up</h1>
        ...
        <input  type="text" placeholder="Full Name" className="h-12 w-[350px] border border-gray-300 rounded outline-0"  style={{paddingLeft:10}}/>
        ...
        <input type="password" placeholder='Confirm Password' className="h-12 w-[350px] border border-gray-300 rounded outline-0"  style={{paddingLeft:10}}/>
        <button className="bg-black h-10 w-[350px] items-center rounded-full text-white font-bold cursor-pointer">SignUp</button>
